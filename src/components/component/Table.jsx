...
//TODO: benerin bagian numbering agar numbernya tidak berulang dan kelanjutan ketika masuk page selanjutnya
                    ...
                    {data.map((row, rowIndex) => {
                        ...
                        return (
                            <tr key={rowIndex} className={`${ rowIndex % 2 === 0 ? 'bg-gray-100' : 'bg-white' } ${ isLastRow ? 'border-b-2 border-gray-200' : '' }`}>
                                ...
                                <td className="py-2 px-4 border flex border-gray-200 gap-2">
                                    <form action="">
                                        <button>
